...
import { AuditLog, APIState, RequestActor } from "../domain";
import { newId, nowIso } from "./id";
import { clone } from "./utils";

export function emptyState(): APIState { return { items: [], runs: [], events: [], auditLogs: [] }; }
...
export class DataStore {
  ...
  getState(): APIState { return this.state; }
  snapshot(): APIState { return clone(this.state); }
