...
const validRoles: Role[] = ["owner", "admin", "agentic_admin", "agent_operator", "agent_developer", "approval_manager", "auditor", "viewer"];
...
const permissionsByRole: Record<Role, string[]> = {
  viewer: ["agentic.agent.read", "agentic.template.read", "agentic.tool.read", "agentic.workflow.read", "agentic.guardrail.read", "agentic.memory.read"],
  agent_developer: ["agentic.agent.read", "agentic.agent.write", "agentic.template.read", "agentic.template.write", "agentic.tool.read", "agentic.workflow.read", "agentic.workflow.write", "agentic.guardrail.read", "agentic.memory.read", "agentic.memory.write", "agentic.evaluation.read", "agentic.evaluation.write"],
  agent_operator: ["agentic.agent.read", "agentic.agent.run", "agentic.template.read", "agentic.tool.read", "agentic.workflow.read", "agentic.workflow.write", "agentic.guardrail.read", "agentic.memory.read", "agentic.memory.write"],
  agentic_admin: ["*"],
  approval_manager: ["agentic.approval.manage", "agentic.agent.read", "agentic.template.read", "agentic.tool.read", "agentic.guardrail.read"],
  auditor: ["agentic.agent.read", "agentic.template.read", "agentic.tool.read", "agentic.workflow.read", "agentic.guardrail.read", "agentic.memory.read", "agentic.evaluation.read", "agentic.audit.read"],
  admin: ["*"],
  owner: ["*"]
};
...
export function requirePermission(role: Role, permission?: string): void {
  if (!hasPermission(role, permission)) {
    throw new HttpError(403, `Role ${role} does not have permission ${permission ?? "required"}`);
  }
}
