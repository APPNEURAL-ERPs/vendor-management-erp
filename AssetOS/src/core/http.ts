...
const apiRoles: Role[] = ["owner", "admin", "asset_admin", "asset_manager", "asset_operator", "viewer"];
...
const permissionsByRole: Record<Role, string[]> = {
  owner: ["*"],
  admin: ["*"],
  asset_admin: ["asset.read", "asset.write", "asset.delete", "asset.category.*", "asset.assignment.*", "asset.maintenance.*", "asset.depreciation.*", "asset.warranty.*", "asset.audit.*", "asset.report", "asset.audit.read"],
  asset_manager: ["asset.read", "asset.write", "asset.category.*", "asset.assignment.*", "asset.maintenance.*", "asset.warranty.*", "asset.audit.*", "asset.report", "asset.audit.read"],
  asset_operator: ["asset.read", "asset.category.read", "asset.assignment.read", "asset.maintenance.read", "asset.report"],
  viewer: ["asset.read", "asset.category.read"]
};
...
export function hasPermission(role: Role, permission?: string): boolean {
  ...
  return granted.some((p) => matchPermission(p, permission));
}
