...
import { URL } from "url";
import { RequestActor, AuditRole } from "../domain";
import { HttpError } from "./errors";
import { isAuditRole, requirePermission } from "./security";
...
export class Router {
  ...
  async handle(req: IncomingMessage, res: ServerResponse): Promise<void> {
    try {
      ...
      const role: AuditRole = isAuditRole(roleHeader) ? roleHeader : "viewer";
