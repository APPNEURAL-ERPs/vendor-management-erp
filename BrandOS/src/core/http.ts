...
export const apiRoles: Role[] = ["owner", "admin", "brand_admin", "brand_manager", "brand_auditor", "viewer"];

const permissionsByRole: Record<Role, string[]> = {
  viewer: ["brand.read"],
  brand_auditor: ["brand.read", "brand.audit.read"],
  brand_manager: ["brand.read", "brand.write", "brand.kit.manage", "brand.asset.manage"],
  brand_admin: ["brand.read", "brand.write", "brand.kit.manage", "brand.guideline.manage", "brand.asset.manage", "brand.audit.read"],
  admin: ["*"],
  owner: ["*"]
};
