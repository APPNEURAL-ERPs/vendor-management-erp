...
export class Router {
  ...
  async handle(req: IncomingMessage, res: ServerResponse): Promise<void> {
    try {
      ...
      const role: CareerRole = isCareerRole(roleHeader) ? roleHeader : "viewer";
...
export function isCareerRole(value: string): value is CareerRole {
  return validRoles.includes(value as CareerRole);
}

export function requirePermission(role: CareerRole, permission?: string): void {
...
export function permissionsFor(role: CareerRole): string[] {
  switch (role) {
    case "viewer":
      return ["career.job.read", "career.application.read", "career.interview.read", "career.offer.read"];
    case "recruiter":
      return ["career.job.read", "career.job.write", "career.application.read", "career.application.write", "career.interview.read", "career.interview.write", "career.analytics.read"];
    case "hiring_manager":
      return ["career.job.read", "career.job.write", "career.application.read", "career.application.write", "career.interview.read", "career.interview.write", "career.offer.read", "career.offer.write", "career.careerpath.read", "career.analytics.read"];
    case "hr_admin":
      return ["career.job.read", "career.job.write", "career.application.read", "career.application.write", "career.interview.read", "career.interview.write", "career.offer.read", "career.offer.write", "career.careerpath.read", "career.skillprofile.read", "career.analytics.read"];
    case "admin":
      return ["*"];
    default:
      return [];
