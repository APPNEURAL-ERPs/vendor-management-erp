...
import { CommunicationState, AuditLog, RequestActor } from "../domain";
import { newId, nowIso } from "./id";
import { clone } from "./utils";

export function emptyState(): CommunicationState {
  return {
    contacts: [],
    presences: [],
    channels: [],
...
export class DataStore {
  ...
  replaceState(nextState: CommunicationState): void {
