...
const validRoles: Role[] = ["owner", "admin", "communication_admin", "communication_manager", "communication_agent", "viewer"];
export function isRole(value: string): value is Role {
  return validRoles.includes(value as Role);
}

const permissionsByRole: Record<Role, string[]> = {
  viewer: ["communication.message.read", "communication.conversation.read", "communication.channel.read"],
  communication_agent: ["communication.message.read", "communication.message.write", "communication.conversation.read", "communication.conversation.write", "communication.channel.read", "communication.call.read"],
