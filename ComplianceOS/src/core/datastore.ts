...
import { AuditLog, ComplianceState, RequestActor } from "../domain";
import { newId, nowIso } from "./id";
import { clone } from "./utils";

export function emptyState(): ComplianceState {
  return {
    frameworks: [],
    requirements: [],
    regulations: [],
...
export class DataStore {
  ...
  snapshot(): ComplianceState {
    return clone(this.state);
  }

  replaceState(nextState: ComplianceState): void {
