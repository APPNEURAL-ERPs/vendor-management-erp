...
const apiRoles: Role[] = ["owner", "admin", "compliance_manager", "compliance_analyst", "auditor", "viewer"];

const permissionsByRole: Record<Role, string[]> = {
  viewer: ["compliance.read"],
  compliance_analyst: ["compliance.read", "compliance.audit.execute"],
  compliance_manager: ["compliance.read", "compliance.write", "compliance.audit.execute", "compliance.report.view"],
  auditor: ["compliance.read", "compliance.audit.execute"],
  admin: ["*"],
  owner: ["*"]
};
