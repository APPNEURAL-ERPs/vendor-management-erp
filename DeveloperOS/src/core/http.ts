...
const apiRoles: Role[] = ["owner", "admin", "developer_admin", "sdk_engineer", "api_developer", "portal_manager", "viewer"];
...
export function permissionsFor(role: Role): string[] {
  const permissions: Record<Role, string[]> = {
    ...
    admin: ["*"],
    developer_admin: ["*"],
    sdk_engineer: ["developer.item.read", "developer.item.write", "developer.sdk.generate", "developer.cli.create", "developer.docs.manage", "developer.audit.read"],
    api_developer: ["developer.item.read", "developer.item.write", "developer.sdk.generate", "developer.cli.create", "developer.docs.manage", "developer.webhook.manage", "developer.audit.read"],
    portal_manager: ["developer.item.read", "developer.portal.manage", "developer.sandbox.access", "developer.apikey.manage", "developer.audit.read"],
    viewer: ["developer.item.read", "developer.audit.read"]
  };
