...
import { AuditLog, EntityState, RequestActor } from "../domain";
import { newId, nowIso } from "./id";
import { clone } from "./utils";

export function emptyState(): EntityState { return { items: [], runs: [], events: [], auditLogs: [] }; }
...
export class DataStore {
  ...
  getState(): EntityState { return this.state; }
  snapshot(): EntityState { return clone(this.state); }
