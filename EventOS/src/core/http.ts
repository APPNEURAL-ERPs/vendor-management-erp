...
const validRoles: Role[] = ["owner", "admin", "event_admin", "event_engineer", "event_analyst", "viewer"];
...
const permissionsByRole: Record<Role, string[]> = {
  viewer: ["event.read", "event.schema.read"],
  event_analyst: ["event.read", "event.schema.read", "event.audit.read"],
  event_engineer: ["event.read", "event.write", "event.publish", "event.subscribe", "event.schema.read", "event.schema.write", "event.audit.read"],
  event_admin: ["*"],
  admin: ["*"],
  owner: ["*"]
};
