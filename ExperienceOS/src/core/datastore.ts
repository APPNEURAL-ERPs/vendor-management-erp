...
import { AuditLog, ExperienceState, RequestActor } from "./domain";
import { newId, nowIso } from "./id";
import { clone } from "./utils";

export function emptyState(): ExperienceState {
  return {
    personas: [],
    journeys: [],
    onboardings: [],
...
export class DataStore {
  ...
  snapshot(): ExperienceState {
    return clone(this.state);
  }

  replaceState(nextState: ExperienceState): void {
