...
export const apiRoles: Role[] = ["owner", "admin", "experience_admin", "ux_designer", "ux_analyst", "content_manager", "viewer"];

const permissionsByRole: Record<Role, string[]> = {
  viewer: ["experience.persona.read", "experience.journey.read", "experience.flow.read", "experience.audit.read", "experience.abtest.read", "experience.feedback.read"],
  content_manager: ["experience.persona.read", "experience.journey.read", "experience.flow.read", "experience.microcopy.read", "experience.microcopy.write"],
  ux_analyst: ["experience.persona.read", "experience.journey.read", "experience.flow.read", "experience.audit.read", "experience.audit.write", "experience.abtest.read", "experience.feedback.read", "experience.metrics.read"],
  ux_designer: ["experience.persona.read", "experience.journey.read", "experience.flow.write", "experience.journey.write", "experience.persona.write", "experience.microcopy.read", "experience.microcopy.write", "experience.wireframe.read", "experience.wireframe.write", "experience.template.read", "experience.template.write"],
  experience_admin: ["*"],
  admin: ["*"],
  owner: ["*"]
};
