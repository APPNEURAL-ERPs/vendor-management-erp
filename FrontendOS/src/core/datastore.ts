...
import { AuditLog, FrontendState, RequestActor } from "../domain";
import { newId, nowIso } from "./id";
import { clone } from "./utils";

export function emptyState(): FrontendState { return { items: [], runs: [], events: [], auditLogs: [] }; }
...
export class DataStore {
  ...
  getState(): FrontendState { return this.state; }
  snapshot(): FrontendState { return clone(this.state); }
