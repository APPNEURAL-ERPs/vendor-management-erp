# InfrastructureOS Planning Alignment

InfrastructureOS follows the APPNEURAL OS planning contract from `APPNEURAL Plannings/OSs`.

## Package

- Package: `@appneurox/infrastructureos`
