...
import { AuditLog, InfrastructureState, RequestActor } from "../types";
import { newId, nowIso } from "./id";
import { clone } from "./utils";

export function emptyState(): InfrastructureState {
  return {
    servers: [],
    databases: [],
    networks: [],
...
export class DataStore {
  ...
  replaceState(nextState: InfrastructureState): void {
