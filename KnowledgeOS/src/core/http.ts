...
const validRoles: Role[] = ["owner", "admin", "knowledge_admin", "knowledge_manager", "knowledge_contributor", "viewer"];
...
const permissionsByRole: Record<Role, string[]> = {
  viewer: ["knowledge.article.read", "knowledge.space.read", "knowledge.sop.read", "knowledge.search.execute"],
  knowledge_contributor: ["knowledge.article.read", "knowledge.article.write", "knowledge.space.read", "knowledge.sop.read", "knowledge.sop.write", "knowledge.search.execute"],
  knowledge_manager: ["knowledge.article.read", "knowledge.article.write", "knowledge.space.read", "knowledge.space.write", "knowledge.sop.read", "knowledge.sop.write", "knowledge.search.execute", "knowledge.faq.write", "knowledge.playbook.write", "knowledge.decision.write"],
  knowledge_admin: ["*"],
  admin: ["*"],
  owner: ["*"]
};
