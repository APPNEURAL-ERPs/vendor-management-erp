# LegalOS Planning Alignment

LegalOS follows the APPNEURAL OS planning contract from `APPNEURAL Plannings/OSs`.

## Package

- Package: `@appneurox/legalos`
- Domain API namespace: `/v1/legal`
