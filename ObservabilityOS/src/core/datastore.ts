...
import { ObservabilityState, AuditLog, RequestActor } from "./domain";
import { newId, nowIso } from "./id";
import { clone } from "./utils";

export function emptyState(): ObservabilityState {
  return {
    logs: [],
    metricDefinitions: [],
    metricPoints: [],
...
export class DataStore {
  ...
  snapshot(): ObservabilityState {
    return clone(this.state);
  }

  replaceState(nextState: ObservabilityState): void {
