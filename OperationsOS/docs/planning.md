# OperationsOS Planning Alignment

OperationsOS follows the APPNEURAL OS planning contract from `APPNEURAL Plannings/OSs`.

## Package

- Package: `@appneurox/operationsos`
- Domain API namespace: `/v1/operations`
- Modes: standalone, platform
- Related systems: BusinessOS, AutomationOS
