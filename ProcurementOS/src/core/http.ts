...
const apiRoles: Role[] = ["owner", "admin", "procurement_manager", "procurement_analyst", "approver", "requester", "viewer"];
  ...
  async handle(req: IncomingMessage, res: ServerResponse): Promise<void> {
    try {
      ...
      const actor: RequestActor = {
        ...
        role: isRole(getHeader(req, "x-role") ?? "viewer") ? getHeader(req, "x-role") as Role : "viewer"
      };
