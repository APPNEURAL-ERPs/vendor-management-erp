...
import { AuditLog, ProductState, RequestActor } from "./domain";
import { newId, nowIso } from "./id";
import { clone } from "./utils";
export function emptyState(): ProductState { return { products: [], versions: [], roadmapItems: [], requirements: [], features: [], backlogItems: [], releases: [], components: [], boms: [], changeRequests: [], events: [], auditLogs: [] }; }
export class DataStore {
  ...
  getState(): ProductState { return this.state; }
  snapshot(): ProductState { return clone(this.state); }
  replaceState(nextState: ProductState): void { this.state = nextState; this.save(); }
