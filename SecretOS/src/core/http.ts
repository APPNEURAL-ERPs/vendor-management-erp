...
const validRoles: Role[] = ["owner", "admin", "secret_admin", "secret_manager", "security_analyst", "auditor", "viewer"];
...
const permissionsByRole: Record<Role, string[]> = {
  viewer: ["secret.read", "secret.audit.read"],
  auditor: ["secret.read", "secret.audit.read"],
  security_analyst: ["secret.read", "secret.audit.read", "secret.risk.view"],
  secret_manager: ["secret.read", "secret.write", "secret.rotate", "secret.audit.read"],
  secret_admin: ["secret.read", "secret.write", "secret.rotate", "secret.revoke", "secret.reveal", "secret.audit.read", "secret.access.request", "secret.vault.manage", "secret.policy.manage"],
  admin: ["*"],
  owner: ["*"]
};
