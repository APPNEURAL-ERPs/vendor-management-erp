...
import { AuditLog, TaskState, RequestActor } from "../domain";
import { newId, nowIso } from "./id";
import { clone } from "./utils";

export function emptyState(): TaskState { return { items: [], runs: [], events: [], auditLogs: [] }; }
...
export class DataStore {
  ...
  snapshot(): TaskState { return clone(this.state); }
