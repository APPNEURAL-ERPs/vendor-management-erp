...
import { AuditLog, UnifiedState, RequestActor } from "../domain";
import { newId, nowIso } from "./id";
import { clone } from "./utils";

export function emptyState(): UnifiedState { return { items: [], runs: [], events: [], auditLogs: [] }; }
...
export class DataStore {
  ...
  getState(): UnifiedState { return this.state; }
  snapshot(): UnifiedState { return clone(this.state); }
